...
#define HASP_USE_WIFI 1//(ARDUINO_ARCH_ESP32 > 0 || ARDUINO_ARCH_ESP8266 > 0)
#endif

#ifndef HASP_USE_CAPTIVE_PORTAL
#define HASP_USE_CAPTIVE_PORTAL 1//(ARDUINO_ARCH_ESP32 > 0) && (HASP_USE_WIFI > 0)
#endif
...
#define HASP_USE_ARDUINOOTA (HASP_HAS_NETWORK)
#endif
...
#define HASP_USE_MQTT_ASYNC 0//(HASP_TARGET_PC)
#endif

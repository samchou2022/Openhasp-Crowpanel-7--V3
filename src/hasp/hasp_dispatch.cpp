...
#endif
// FTP support disabled in minimal build
// #if HASP_USE_FTP > 0
...
#endif
// Telnet support disabled in minimal build
// #if HASP_USE_TELNET > 0
//     telnetStop();
// #endif
#if HASP_USE_CONFIG > 0
...
{
// Telnet and FTP support disabled in minimal build
// #if HASP_USE_TELNET > 0
...
#endif
#endif
#if HASP_USE_CONFIG > 0 && HASP_TARGET_ARDUINO && defined(HASP_USE_WIFI)

...
#endif
    // LOG_INFO removed to prevent watchdog timeout
    Serial.println("TFT Service Started");
}
...
void guiSetup()
{
    ...
    // Initialize LVGL with delays for stability
    ...
    //esp_task_wdt_reset(); // Feed watchdog before display registration
    delay(100);
    lv_disp_t* display = lv_disp_drv_register(&disp_drv);
    //esp_task_wdt_reset(); // Feed watchdog after display registration
    delay(50);
    ...
    */
    ...
    // LOG_INFO removed to prevent watchdog timeout
    Serial.println("LVGL Service Started");
}
